...
type MathCaptchaProps = {
  /**
   * Called when captcha data changes (new token/question).
   * Parent uses this to get the current token for submission.
   */
  onCaptchaChange?: (captcha: CaptchaData | null) => void;
  /**
   * If true, the captcha value is controlled externally.
   * Parent must provide captchaToken and captchaAnswer.
   */
  captchaToken?: string;
    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="p-3 text-gray-500 hover:text-primary-600 hover:bg-primary-50 rounded-xl transition-all disabled:opacity-50"
