// Simple hash function (no crypto dependency for Edge Runtime compatibility)
const CAPTCHA_SECRET = "annajah-captcha-2024";
...
export function generateCaptcha(): { token: string; question: string } {
  ...
  // Token: answerHash + nonce (uses simple hash, not crypto)
